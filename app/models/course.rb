class Course < ActiveRecord::Base
  attr_accessible :name, :user_id, :f_day, :l_day, :course_id, :pass_d_points_attributes, :lecture_days_attributes, :designated_points_attributes, :students_attributes, :attendances_attributes
